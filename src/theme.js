...
export default {
  ...
  colors: {
    ...
    "editorGroupHeader.tabsBackground": COLORS.WRAPPER_BG,
    "tab.activeBackground": COLORS.EDITOR_BG,
    "tab.activeForeground": COLORS.GRAY,
    "tab.border": COLORS.WRAPPER_BG,
    "tab.activeBorderTop": "#FF79C680",
    "tab.inactiveBackground": COLORS.EDITOR_BG,
    "tab.inactiveForeground": COLORS.GRAY_DARK,
    ...
    "titleBar.activeBackground": COLORS.EDITOR_BG,
